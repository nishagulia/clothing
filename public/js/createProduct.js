...
const createProduct = (data) => {
    ...
    <div class="product-card">
        ...
        ${data.draft ? `<span class="tags">draft</span>` : ''}
            ...
            <button class="card-action-btn edit-btn delete-popup-btn" onclick="openDeletePopup('${data.id}')"><img src="img/delete.png" alt=""></button>
        </div>
